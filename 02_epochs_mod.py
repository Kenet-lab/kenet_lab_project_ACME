...
for subject in get_subject_ids(get_subjects(paradigm_dir)):
    ...
    # do pre-processing
    raw_filt = filter_signal(raw, l_freq, h_freq, n_jobs, eeg, subject_paradigm_dir, eeg_bads_fname)
    if preproc_ssp:
    ...
    epochs = generate_epochs(raw_filt, events_baseline, conditions_dicts, epochs_parameters_dict, subject_preproc_subdir,
